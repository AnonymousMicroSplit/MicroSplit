...
## end of configuration
 ...
 start () {
  ## outbound.
  echo "configure user latency to remaining delay 30ms"
  ...
  tc filter add dev $INTERFACE protocol ip parent 1:0 prio 1 u32 match ip dst $USERDB_IP flowid 1:11
 ...
 stop () {
  ...
  echo "stop network rule in user"
